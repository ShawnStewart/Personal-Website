...
export default class SlidingPuzzle extends Component {
    ...
    handleTileClick = e => {
        ...
        let childNodes = [].slice.call(puzzle.childNodes);
        const distance =
            childNodes.indexOf(e.target) - childNodes.indexOf(empty);
        if (
            (distance === -4 ||
                distance === -1 ||
                distance === 1 ||
                ...
                <div className="SlidingPuzzle__Body">
                    <Container textAlign="center">
                        <div className="SlidingPuzzle__Buttons">
                            ...
                            <Link
                                to="/legacy/projects/sliding-puzzle/hiscores"
                                onClick={() => {
                                    document
          ...
          <Button onClick={this.cheatTest}>Test</Button> */}
                        ...
                        {this.state.completed ? (
                            this.state.submitSuccess ? (
                                ...
                                <div>
                                    <p>
                                        Congratulations, you've won! Enter your
                                        name for the hiscores.
                                    </p>
                                    <Input
